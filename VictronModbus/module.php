...
class VictronModbus extends IPSModule {
    ...
    public function RequestRead() {
        ...
        $this->SendDebug("GetData", "Grid L1".": ".$GridL1, 0);
        $this->SetValue($this->GetIDForIdent("GridL1"), ($GridL1[1] + ($GridL1[2] << 16))/1);
        ...
        $this->SendDebug("GetData", "Grid L2".": ".$GridL2, 0);
        $this->SetValue($this->GetIDForIdent("GridL2"), ($GridL2[1] + ($GridL2[2] << 16))/1);
        ...
        $this->SendDebug("GetData", "Grid L3".": ".$GridL3, 0);
        $this->SetValue($this->GetIDForIdent("GridL3"), ($GridL3[1] + ($GridL3[2] << 16))/1);
